(function(){const K=document.createElement("link").relList;if(K&&K.supports&&K.supports("modulepreload"))return;for(const $ of document.querySelectorAll('link[rel="modulepreload"]'))Z($);new MutationObserver($=>{for(const V of $)if(V.type==="childList")for(const B of V.addedNodes)B.tagName==="LINK"&&B.rel==="modulepreload"&&Z(B)}).observe(document,{childList:!0,subtree:!0});function Q($){const V={};return $.integrity&&(V.integrity=$.integrity),$.referrerPolicy&&(V.referrerPolicy=$.referrerPolicy),$.crossOrigin==="use-credentials"?V.credentials="include":$.crossOrigin==="anonymous"?V.credentials="omit":V.credentials="same-origin",V}function Z($){if($.ep)return;$.ep=!0;const V=Q($);fetch($.href,V)}})();const De="modulepreload",Ae=function(q,K){return new URL(q,K).href},we={},Be=function(K,Q,Z){let $=Promise.resolve();if(Q&&Q.length>0){const B=document.getElementsByTagName("link"),i=document.querySelector("meta[property=csp-nonce]"),o=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));$=Promise.allSettled(Q.map(h=>{if(h=Ae(h,Z),h in we)return;we[h]=!0;const d=h.endsWith(".css"),n=d?'[rel="stylesheet"]':"";if(!!Z)for(let g=B.length-1;g>=0;g--){const l=B[g];if(l.href===h&&(!d||l.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${h}"]${n}`))return;const _=document.createElement("link");if(_.rel=d?"stylesheet":De,d||(_.as="script"),_.crossOrigin="",_.href=h,o&&_.setAttribute("nonce",o),document.head.appendChild(_),d)return new Promise((g,l)=>{_.addEventListener("load",g),_.addEventListener("error",()=>l(new Error(`Unable to preload CSS for ${h}`)))})}))}function V(B){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=B,window.dispatchEvent(i),!i.defaultPrevented)throw B}return $.then(B=>{for(const i of B||[])i.status==="rejected"&&V(i.reason);return K().catch(V)})};var xe={exports:{}};(function(q,K){(function(Q,Z){q.exports=Z()})(globalThis,()=>(()=>{var Q={4567:function(B,i,o){var h=this&&this.__decorate||function(e,t,a,p){var u,m=arguments.length,c=m<3?t:p===null?p=Object.getOwnPropertyDescriptor(t,a):p;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")c=Reflect.decorate(e,t,a,p);else for(var v=e.length-1;v>=0;v--)(u=e[v])&&(c=(m<3?u(c):m>3?u(t,a,c):u(t,a))||c);return m>3&&c&&Object.defineProperty(t,a,c),c},d=this&&this.__param||function(e,t){return function(a,p){t(a,p,e)}};Object.defineProperty(i,"__esModule",{value:!0}),i.AccessibilityManager=void 0;const n=o(9042),f=o(9924),_=o(844),g=o(4725),l=o(2585),s=o(3656);let r=i.AccessibilityManager=class extends _.Disposable{constructor(e,t,a,p){super(),this._terminal=e,this._coreBrowserService=a,this._renderService=p,this._rowColumns=new WeakMap,this._liveRegionLineCount=0,this._charsToConsume=[],this._charsToAnnounce="",this._accessibilityContainer=this._coreBrowserService.mainDocument.createElement("div"),this._accessibilityContainer.classList.add("xterm-accessibility"),this._rowContainer=this._coreBrowserService.mainDocument.createElement("div"),this._rowContainer.setAttribute("role","list"),this._rowContainer.classList.add("xterm-accessibility-tree"),this._rowElements=[];for(let u=0;u<this._terminal.rows;u++)this._rowElements[u]=this._createAccessibilityTreeNode(),this._rowContainer.appendChild(this._rowElements[u]);if(this._topBoundaryFocusListener=u=>this._handleBoundaryFocus(u,0),this._bottomBoundaryFocusListener=u=>this._handleBoundaryFocus(u,1),this._rowElements[0].addEventListener("focus",this._topBoundaryFocusListener),this._rowElements[this._rowElements.length-1].addEventListener("focus",this._bottomBoundaryFocusListener),this._refreshRowsDimensions(),this._accessibilityContainer.appendChild(this._rowContainer),this._liveRegion=this._coreBrowserService.mainDocument.createElement("div"),this._liveRegion.classList.add("live-region"),this._liveRegion.setAttribute("aria-live","assertive"),this._accessibilityContainer.appendChild(this._liveRegion),this._liveRegionDebouncer=this.register(new f.TimeBasedDebouncer(this._renderRows.bind(this))),!this._terminal.element)throw new Error("Cannot enable accessibility before Terminal.open");this._terminal.element.insertAdjacentElement("afterbegin",this._accessibilityContainer),this.register(this._terminal.onResize(u=>this._handleResize(u.rows))),this.register(this._terminal.onRender(u=>this._refreshRows(u.start,u.end))),this.register(this._terminal.onScroll(()=>this._refreshRows())),this.register(this._terminal.onA11yChar(u=>this._handleChar(u))),this.register(this._terminal.onLineFeed(()=>this._handleChar(`
...
`};async function Me(){const{loadPyodide:q}=await Be(async()=>{const{loadPyodide:K}=await import("https://cdn.jsdelivr.net/pyodide/v0.29.3/full/pyodide.mjs");return{loadPyodide:K}},[],import.meta.url);return q({indexURL:"https://cdn.jsdelivr.net/pyodide/v0.29.3/full/"})}async function He(q,K){await q.loadPackage("micropip"),await q.runPythonAsync("import micropip");const Q=JSON.stringify(K);await q.runPythonAsync(`import micropip
await micropip.install(${Q})`)}const ye=document.getElementById("status"),Fe=document.getElementById("terminal"),Ce={default:{bg:"#0a0a0a",fg:"#ffffff",cursor:"#ffffff",selection:"rgba(255, 255, 255, 0.3)"},retro:{bg:"#0a0a0a",fg:"#00ff41",cursor:"#00ff41",selection:"rgba(0, 255, 65, 0.3)"},light:{bg:"#ffffff",fg:"#000000",cursor:"#000000",selection:"rgba(0, 0, 0, 0.2)"},dark:{bg:"#0a0a0a",fg:"#ffffff",cursor:"#ffffff",selection:"rgba(255, 255, 255, 0.3)"},mono:{bg:"#0a0a0a",fg:"#cccccc",cursor:"#cccccc",selection:"rgba(255, 255, 255, 0.2)"},pastel:{bg:"#1e1e2e",fg:"#cba6f7",cursor:"#cba6f7",selection:"rgba(203, 166, 247, 0.3)"}};function Ne(q){const K=Ce[q]||Ce.default;document.body.style.background=K.bg,document.body.style.color=K.fg,document.documentElement.style.setProperty("--term-bg",K.bg);const Q=document.getElementById("terminal-container");Q&&(Q.style.background=K.bg),window.term&&(window.term.options.theme={background:K.bg,foreground:K.fg,cursor:K.cursor,selection:K.selection}),document.querySelectorAll("#theme-buttons button").forEach($=>$.classList.remove("active"));const Z=document.querySelector(`#theme-buttons button[data-theme="${q}"]`);Z&&Z.classList.add("active")}window.setWebTheme=Ne;const ee=new Oe.Terminal({cursorBlink:!0,cursorStyle:"block",fontSize:14,fontFamily:"'Fira Code', 'Consolas', monospace",theme:{background:"#0a0a0a",foreground:"#ffffff",cursor:"#ffffff",selection:"rgba(255, 255, 255, 0.3)"}});window.term=ee;const Se=new Ie.FitAddon;ee.loadAddon(Se);ee.open(Fe);Se.fit();window.addEventListener("resize",()=>Se.fit());window.pythonLineBuffer=[];window.termWrite=q=>{const K=q.replace(/\r\n/g,`
`).replace(/\r/g,`
`).replace(/\n/g,`\r
`);ee.write(K)};let Le=!1;window.setRawInput=q=>{Le=q};let ae=null,_e=[],oe="",de=null;window.pyc_readline=()=>new Promise(q=>{_e.length>0?q(_e.shift()):de=q});function Ee(q){de?(de(q),de=null):_e.push(q)}function We(){return _e.length>0?Promise.resolve(_e.shift()):new Promise(q=>{de=q})}ee.onData(q=>{if(Le){try{ae.pyimport("src.ui.input").web_input_queue.append(q)}catch{}return}for(const K of q)K==="\r"?(ee.write(`\r
`),Ee(oe),oe=""):K===""?oe.length>0&&(oe=oe.slice(0,-1),ee.write("\b \b")):K===""?(ee.write(`^C\r
`),Ee("exit"),oe=""):(oe+=K,ee.write(K))});ee.write(`\x1B[2J\x1B[1;1HLoading pyComputer...
...
kernel.boot_sequence()
shell = kernel.shell
`;await ae.runPythonAsync(q);const K="[/] $ ";ee.write(K);async function Q(Z){if(!Z.trim()){ee.write(K);return}ae.globals.set("commandLine",Z);try{await ae.runPythonAsync("shell.execute(commandLine)")}catch(V){if(String(V).includes("SystemExit")){ee.write(`Shell exited.\r
`);return}ee.write(`Error: ${V}\r
`)}ee.write(K)}for(;;){const Z=await We();await Q(Z)}}Ue().catch(q=>{ye.textContent="Failed",ee.write(`Error: ${q}\r
`)});
